...
const Home = () => {
  ...
  const filteredProducts = biddingOnly
  ? product_homes.filter(product_home => 
      checkBiddingStatus(updatedProducts, product_home.product_id))
  : product_homes;
  ...
  return (
    <div className='home'>
      ...
      <div>
        ...
        />
        <label>Show Bidding Products Only</label>
      </div>
      <div className='product_homes'>
      {/* {product_homes.map((product_home) => ( */}
        {filteredProducts.map((product_home) => (
